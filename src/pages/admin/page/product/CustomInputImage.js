  ...
  return (
    <div className="flex flex-col text-black">
      ...
      <div class="flex flex-col  items-start   justify-center w-full">
        ...
        <label for="dropzone-file" class={`"  flex flex-col items-center justify-center w-full h-60 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-bray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500
     dark:hover:bg-gray-600   ${meta.error ? " border border-red-500" : " "} " `
          ...
          <input  {...field}
            ...
            onChange={(event) => {
              ...
              setFieldValue(field.name, myFiles);
